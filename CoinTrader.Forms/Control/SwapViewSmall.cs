...
namespace CoinTrader.Forms.Control
{
    public partial class SwapViewSmall : UserControl, IMarketView
    {
        ...
        private void Clean()
        {
            ...
            StrategyRunner.Instance.StopStrategiesByInstId(this.instId);
        }
