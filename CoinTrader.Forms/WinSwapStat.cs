...
{
    public partial class WinSwapStat : Form
    {
        ...
        private void WinSwapStat_Load(object sender, EventArgs e)
        {
        ...
        public void SetCurrency(string instId)
        {
            this.instId = instId;
            ...
            TradeHistoryManager.Instance.LoadHistory(instId, InstrumentType.Swap);
        }
        ...
        private void Stat(IList<TradeOrder> orders)
        {
            ...
            decimal balanceMoney = 0;// priceBid * (balance.Avalible + balance.Frozen);
            ...
            this.lblBuyCount.Text = totalBuyAmount.ToString(instrument.AmountFormat);  
            this.lblSellCount.Text = totalSellAmount.ToString(instrument.AmountFormat);
